...
//showing the back of player's cards
//if it is "shown", the number of the tile be shown to the opponent
void showcardsback(card deck[], int numberofcards){
  ...
  //shown - shows tile information to the opponent
  //not shown - shows the color of the tile only
  for (int i=0; i<=numberofcards-1; i++){
